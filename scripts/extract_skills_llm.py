...
def main():
    ...
    con.execute("DROP TABLE IF EXISTS job_skills_llm")
    con.execute("""
    ...
    if rows:
        ...
        con.register("llm_df", df)
        con.execute("INSERT INTO job_skills_llm SELECT job_id, skill_id, skill_name, category, posted_date, noc_code FROM llm_df")
